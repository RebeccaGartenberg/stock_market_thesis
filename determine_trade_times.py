...
def get_slow_stochastic_oscillator_2(data, k, d, low_thresh, high_thresh):
    ...
    hourly_osc['highest_high'] = hourly_osc['high'].rolling(k).max()
    hourly_osc['%K'] = ((hourly_osc['close'] - hourly_osc['lowest_low']) / (hourly_osc['highest_high'] - hourly_osc['lowest_low'])) * 100
    # Calculate the %D line
